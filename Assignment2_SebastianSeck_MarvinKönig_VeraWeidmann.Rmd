...
The lincom command (in R: car-package) can be used to model the equation by using the original one without modifying the model. 

NO IDEA!!!! lincom command??? Linear combinations of parameters -> linear hypothesis- package: car? john foxed
