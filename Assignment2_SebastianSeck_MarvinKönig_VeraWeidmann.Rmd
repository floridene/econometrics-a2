...
The intercept of the regression model for household heads with age 25 is shifted by the effect of $25^2 = 625$). Therefore, we adhust $\beta_0$ to $\alpha_0$.
...
The lincom command (in R: car-package) can be used to model the equation by unsing the original one without modifing the model. 
...
Können es auch weg lassen nach Quari :D 
...
-> xtreg gleichung :( -> Look for package!
